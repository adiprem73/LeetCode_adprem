<h2><a href="https://leetcode.com/contest/biweekly-contest-187/problems/minimum-cost-to-convert-string-iii">3995. Minimum Cost to Convert String III</a></h2><h3>Hard</h3><hr><p>You are given two strings, <code>source</code> and <code>target</code>.</p>
